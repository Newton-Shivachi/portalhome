...
urlpatterns = [
    ...
    path("payment/initiate/<str:location>/", initiate_payment, name="initiate_payment"),
    path("signup/", signup, name="signup"),
    path("payment/verify/<str:reference>/<int:house_id>/", verify_payment, name="verify_payment"),
