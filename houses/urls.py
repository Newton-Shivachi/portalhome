...
urlpatterns = [
    ...
    path('pay/<str:location>/', initiate_payment, name='initiate_payment'),
    path('pay/<str:location>/<int:house_id>/', initiate_payment, name='initiate_payment_with_house'),
    path('payment/verify/<str:reference>/', verify_payment, name='verify_payment'),
    path('payment/verify/<str:reference>/<int:house_id>/', verify_payment, name='verify_payment_with_house'),
