...
urlpatterns = [
    ...
    path('pay/<str:location>/', views.initiate_payment, name='initiate_payment'),
    path('pay/<str:location>/<int:house_id>/', views.initiate_payment, name='initiate_payment_with_house'),
    path('payment/verify/<str:reference>/', views.verify_payment, name='verify_payment'),
    path('payment/verify/<str:reference>/<int:house_id>/', views.verify_payment, name='verify_payment_with_house'),
